...
*/
function removeArtist(artistArr, index) {
  artistArr.splice(index, index + 1);
  return artistArr;
}
...
function lotsOfArt(arr) {
  const filteredArray = arr.filter((obj) => obj.paintings > 100);
...
console.log(addArtist(21, 'Yvette', '1996-22', 'Web Development', 'Vietnamese', 'I am Yvette. I am Vietnamese.'))
